...
export function PushDialog({ open, onOpenChange, onSuccess }: PushDialogProps) {
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="force-push" className="font-normal cursor-pointer text-destructive">
                  Force push (--force)
                </Label>
              </div>
            </div>
